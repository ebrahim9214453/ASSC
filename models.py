...
# layer: intent attention w/context (Liu & Lane)
    ...
    model.compile(optimizers.Adam(0.001,amsgrad=True), sample_weight_mode="temporal",loss=SparseCategoricalFocalLoss( gamma=2), metrics=[crf_marginal_accuracy])
